...
.over{
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-md-12">
                                <div class="over overview-wrap">

                                            <h2 class="title-1">overview</h2>
                                            <button onclick="location.href = 'input.php';" class="au-btn au-btn-icon au-btn--blue">
    ...
    <input type="submit" value="Cari" style="padding: 5px; cursor: pointer;">
</form>
...
<table class="table table-borderless table-striped table-earning">
    ...
    if(isset($_GET['cari'])){
        $cari = $_GET['cari'];
        $data = mysqli_query($con, "SELECT * FROM user_info WHERE nama LIKE '%".$cari."%'");                
    }else{
        $data = mysqli_query($con, "SELECT * FROM user_info");     
    }
    $no = 1;
