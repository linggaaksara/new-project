                        ...
                        <form method="post">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Memasukan Data</strong> Pegawai
                                    </div>
                                            ...
                                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <input type="text" id="text-input" name="name-input" placeholder="Nama" class="form-control" required>
                                                        <small class="form-text text-muted">Masukan Nama Dengan Lengkap</small>
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col col-md-3">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        ...
                                                        <option value="Lead Indonesia">Lead Indonesia</option>
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <input type="text" id="email-input" name="user-input" placeholder="Username" class="form-control" required>
                                                        <small class="help-block form-text">Silahkan masukan email</small>
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col col-md-3">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <input type="password" id="password-input" name="pass-input" placeholder="Password" class="form-control" required>
                                                        <small class="help-block form-text">Silahkan masukan password dengan benar</small>
                                                    </div>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col col-md-3">
                                                        ...
                                                        <div class="form-check">
                                                            <div class="radio">
                                                                <label for="radio1" class="form-check-label ">
                                                                    <input type="radio" id="radio1" name="radios" value="Pria" class="form-check-input" required>
                                                                    Pria
                                                                </label>
                                                            </div>
                                                            <div class="radio">
                                                                <label for="radio2" class="form-check-label ">
                                                                    <input type="radio" id="radio2" name="radios" value="Wanita" class="form-check-input" required>
                                                                    Wanita
                                                                </label>
                                                            </div>   
                                                        </div>
                                    ...
                                    $nama = $_POST['name-input'];
                                    $departmen = $_POST['select'];
                                    $user = $_POST['user-input'];
                                    $pass = $_POST['pass-input'];
                                    $jk = $_POST['radios'];

                                    $sql = mysqli_query($con,"INSERT INTO user_info(nama,departmen,jk,id_user,username,password) VALUES('$nama' , '$departmen' , '$jk', '' , '$user' , '$pass' )");
